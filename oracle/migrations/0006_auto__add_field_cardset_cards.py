...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardSet.cards'
        db.add_column('oracle_cardset', 'cards', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CardSet.cards'
        db.delete_column('oracle_cardset', 'cards')
