...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CardImage', fields ['mvid']
        db.create_unique('oracle_cardimage', ['mvid'])


    def backwards(self, orm):
        # Removing unique constraint on 'CardImage', fields ['mvid']
        db.delete_unique('oracle_cardimage', ['mvid'])
