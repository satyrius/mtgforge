...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataProviderPage.name'
        db.add_column('oracle_dataproviderpage', 'name', self.gf('contrib.fields.NullCharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataProviderPage.name'
        db.delete_column('oracle_dataproviderpage', 'name')
