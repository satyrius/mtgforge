...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CardRelease.default_art'
        db.delete_column('oracle_cardrelease', 'default_art')

        # Deleting field 'CardRelease.scan'
        db.delete_column('oracle_cardrelease', 'scan')


    def backwards(self, orm):
        # Adding field 'CardRelease.default_art'
        db.add_column('oracle_cardrelease', 'default_art',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CardRelease.scan'
        db.add_column('oracle_cardrelease', 'scan',
