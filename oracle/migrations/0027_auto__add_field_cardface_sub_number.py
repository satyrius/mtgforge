...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CardFace.sub_number'
        db.add_column('oracle_cardface', 'sub_number',
                      self.gf('contrib.fields.NullCharField')(max_length=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CardFace.sub_number'
        db.delete_column('oracle_cardface', 'sub_number')
