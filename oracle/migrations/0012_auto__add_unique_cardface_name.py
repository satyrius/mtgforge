...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CardFace', fields ['name']
        db.create_unique('oracle_cardface', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CardFace', fields ['name']
        db.delete_unique('oracle_cardface', ['name'])
