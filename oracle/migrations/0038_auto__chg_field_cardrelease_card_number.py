...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CardRelease.card_number'
        db.alter_column('oracle_cardrelease', 'card_number', self.gf('contrib.fields.NullCharField')(max_length=4, null=True))


    def backwards(self, orm):
        
        # Changing field 'CardRelease.card_number'
        db.alter_column('oracle_cardrelease', 'card_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        'oracle.cardrelease': {
            ...
            'card_number': ('contrib.fields.NullCharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
