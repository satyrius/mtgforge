...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CardL10n.rules'
        db.alter_column('oracle_cardl10n', 'rules', self.gf('contrib.fields.NullTextField')(null=True))

        # Changing field 'CardL10n.flavor'
        db.alter_column('oracle_cardl10n', 'flavor', self.gf('contrib.fields.NullTextField')(null=True))

        # Changing field 'CardFace.rules'
        db.alter_column('oracle_cardface', 'rules', self.gf('contrib.fields.NullTextField')(null=True))

        # Changing field 'CardFace.mana_cost'
        db.alter_column('oracle_cardface', 'mana_cost', self.gf('contrib.fields.NullCharField')(max_length=20, null=True))

        # Changing field 'CardFace.flavor'
        db.alter_column('oracle_cardface', 'flavor', self.gf('contrib.fields.NullTextField')(null=True))

        # Changing field 'Card.name'
        db.alter_column('oracle_card', 'name', self.gf('contrib.fields.NullCharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'CardL10n.rules'
        db.alter_column('oracle_cardl10n', 'rules', self.gf('contrib.fields.NullTextField')(default=''))

        # Changing field 'CardL10n.flavor'
        db.alter_column('oracle_cardl10n', 'flavor', self.gf('contrib.fields.NullTextField')(default=''))

        # Changing field 'CardFace.rules'
        db.alter_column('oracle_cardface', 'rules', self.gf('contrib.fields.NullTextField')(default='', max_length=255))

        # Changing field 'CardFace.mana_cost'
        db.alter_column('oracle_cardface', 'mana_cost', self.gf('contrib.fields.NullCharField')(default='', max_length=20))

        # Changing field 'CardFace.flavor'
        db.alter_column('oracle_cardface', 'flavor', self.gf('contrib.fields.NullTextField')(default=''))

        # Changing field 'Card.name'
        db.alter_column('oracle_card', 'name', self.gf('contrib.fields.NullCharField')(default='', max_length=255))
