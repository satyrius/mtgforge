...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Card.faces_count'
        db.add_column('oracle_card', 'faces_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Card.faces_count'
        db.delete_column('oracle_card', 'faces_count')
