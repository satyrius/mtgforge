...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CardRelease.art'
        db.add_column('oracle_cardrelease', 'art',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oracle.CardImage'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CardRelease.art'
        db.delete_column('oracle_cardrelease', 'art_id')
