...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'DataProviderPage', fields ['url_hash', 'name']
        db.delete_unique('oracle_dataproviderpage', ['url_hash', 'name'])

        # Rename field 'DataProviderPage.name' to 'DataProviderPage.class_name'
        db.rename_column('oracle_dataproviderpage', 'name', 'class_name')

        # Adding unique constraint on 'DataProviderPage', fields ['class_name', 'url_hash']
        db.create_unique('oracle_dataproviderpage', ['class_name', 'url_hash'])


    def backwards(self, orm):

        # Removing unique constraint on 'DataProviderPage', fields ['class_name', 'url_hash']
        db.delete_unique('oracle_dataproviderpage', ['class_name', 'url_hash'])

        # Rename field 'DataProviderPage.class_name' to 'DataProviderPage.name'
        db.rename_column('oracle_dataproviderpage', 'class_name', 'name')

        # Adding unique constraint on 'DataProviderPage', fields ['url_hash', 'name']
        db.create_unique('oracle_dataproviderpage', ['url_hash', 'name'])
    ...
    models = {
        ...
        'oracle.cardface': {
            ...
            'colors': ('arrayfields.fields.IntegerArrayField', [], {'default': '[]'}),
