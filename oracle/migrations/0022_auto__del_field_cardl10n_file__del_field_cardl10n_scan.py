...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CardL10n.file'
        db.delete_column('oracle_cardl10n', 'file')

        # Deleting field 'CardL10n.scan'
        db.delete_column('oracle_cardl10n', 'scan')

    def backwards(self, orm):
        # Adding field 'CardL10n.file'
        db.add_column('oracle_cardl10n', 'file',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CardL10n.scan'
        db.add_column('oracle_cardl10n', 'scan',
                      self.gf('django.db.models.fields.URLField')(null=True, blank=True, max_length=200),
                      keep_default=False)
