...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CardSet.name_ru'
        db.alter_column('oracle_cardset', 'name_ru', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))

        # Changing field 'CardSet.name'
        db.alter_column('oracle_cardset', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'CardSet.acronym'
        db.alter_column('oracle_cardset', 'acronym', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10))

        # Changing field 'CardSet.name_en'
        db.alter_column('oracle_cardset', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'CardSet.name_ru'
        db.alter_column('oracle_cardset', 'name_ru', self.gf('contrib.fields.NullCharField')(unique=True, max_length=255, null=True))

        # Changing field 'CardSet.name'
        db.alter_column('oracle_cardset', 'name', self.gf('contrib.fields.NullCharField')(max_length=255, unique=True))

        # Changing field 'CardSet.acronym'
        db.alter_column('oracle_cardset', 'acronym', self.gf('contrib.fields.NullCharField')(max_length=10, unique=True))

        # Changing field 'CardSet.name_en'
        db.alter_column('oracle_cardset', 'name_en', self.gf('contrib.fields.NullCharField')(unique=True, max_length=255, null=True))
