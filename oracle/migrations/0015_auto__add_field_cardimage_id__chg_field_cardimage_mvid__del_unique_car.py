...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing pk constraint on 'CardImage', fields ['mvid']
        db.execute('alter table oracle_cardimage drop constraint oracle_cardimage_pkey')

        # Adding field 'CardImage.id'
        db.add_column('oracle_cardimage', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=None, primary_key=True),
                      keep_default=False)

        # Changing field 'CardImage.mvid'
        db.alter_column('oracle_cardimage', 'mvid', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'CardImage.mvid'
        raise RuntimeError("Cannot reverse this migration. 'CardImage.mvid' and its values cannot be restored.")
    ...
    models = {
        ...
        'oracle.cardimage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mvid': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'oracle.cardrelease': {
            ...
            'art_bkp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
