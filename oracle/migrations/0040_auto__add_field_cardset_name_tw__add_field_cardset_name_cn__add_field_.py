...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardSet.name_tw'
        db.add_column('oracle_cardset', 'name_tw', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'CardSet.name_cn'
        db.add_column('oracle_cardset', 'name_cn', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'CardSet.name_de'
        db.add_column('oracle_cardset', 'name_de', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'CardSet.name_fr'
        db.add_column('oracle_cardset', 'name_fr', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'CardSet.name_it'
        db.add_column('oracle_cardset', 'name_it', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'CardSet.name_jp'
        db.add_column('oracle_cardset', 'name_jp', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'CardSet.name_ko'
        db.add_column('oracle_cardset', 'name_ko', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'CardSet.name_pt'
        db.add_column('oracle_cardset', 'name_pt', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'CardSet.name_es'
        db.add_column('oracle_cardset', 'name_es', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'CardSet.name_tw'
        db.delete_column('oracle_cardset', 'name_tw')

        # Deleting field 'CardSet.name_cn'
        db.delete_column('oracle_cardset', 'name_cn')

        # Deleting field 'CardSet.name_de'
        db.delete_column('oracle_cardset', 'name_de')

        # Deleting field 'CardSet.name_fr'
        db.delete_column('oracle_cardset', 'name_fr')

        # Deleting field 'CardSet.name_it'
        db.delete_column('oracle_cardset', 'name_it')

        # Deleting field 'CardSet.name_jp'
        db.delete_column('oracle_cardset', 'name_jp')

        # Deleting field 'CardSet.name_ko'
        db.delete_column('oracle_cardset', 'name_ko')

        # Deleting field 'CardSet.name_pt'
        db.delete_column('oracle_cardset', 'name_pt')

        # Deleting field 'CardSet.name_es'
        db.delete_column('oracle_cardset', 'name_es')
