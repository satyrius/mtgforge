...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CardL10n.artist'
        db.alter_column('oracle_cardl10n', 'artist_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['oracle.Artist']))


    def backwards(self, orm):
        
        # Changing field 'CardL10n.artist'
        db.alter_column('oracle_cardl10n', 'artist_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oracle.Artist'], null=True))
