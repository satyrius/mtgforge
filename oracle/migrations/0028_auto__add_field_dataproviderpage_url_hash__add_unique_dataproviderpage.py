...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataProviderPage.url_hash'
        db.add_column('oracle_dataproviderpage', 'url_hash', self.gf('django.db.models.fields.CharField')(default=None, max_length=40), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DataProviderPage.url_hash'
        db.delete_column('oracle_dataproviderpage', 'url_hash')
    ...
    models = {
        ...
        'oracle.dataproviderpage': {
            'Meta': {'unique_together': "(('url_hash', 'name'),)", 'object_name': 'DataProviderPage'},
