...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CardImage.artist'
        db.add_column('oracle_cardimage', 'artist',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oracle.Artist'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CardImage.artist'
        db.delete_column('oracle_cardimage', 'artist_id')
