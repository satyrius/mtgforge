...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CardRelease.artist'
        db.delete_column('oracle_cardrelease', 'artist_id')


    def backwards(self, orm):
        
        # Adding field 'CardRelease.artist'
        db.add_column('oracle_cardrelease', 'artist', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['oracle.Artist']), keep_default=False)
