...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CardImage.scan'
        db.alter_column('oracle_cardimage', 'scan', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CardImage.scan'
        raise RuntimeError("Cannot reverse this migration. 'CardImage.scan' and its values cannot be restored.")
