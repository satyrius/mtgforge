...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardL10n.artist'
        db.add_column('oracle_cardl10n', 'artist', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oracle.Artist'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CardL10n.artist'
        db.delete_column('oracle_cardl10n', 'artist_id')
