...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DataProviderPage.data_provider'
        db.alter_column('oracle_dataproviderpage', 'data_provider_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oracle.DataProvider'], null=True))


    def backwards(self, orm):
        
        # Changing field 'DataProviderPage.data_provider'
        db.alter_column('oracle_dataproviderpage', 'data_provider_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['oracle.DataProvider']))
