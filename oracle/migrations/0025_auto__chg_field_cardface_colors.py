...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CardFace.colors'
        db.alter_column('oracle_cardface', 'colors', self.gf('arrayfields.fields.IntegerArrayField')())


    def backwards(self, orm):
        
        # Changing field 'CardFace.colors'
        db.alter_column('oracle_cardface', 'colors', self.gf('arrayfields.fields.IntegerArrayField')(null=True))
