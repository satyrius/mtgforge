...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardFace.colors'
        db.add_column('oracle_cardface', 'colors', self.gf('arrayfields.fields.IntegerArrayField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'CardFace.colors'
        db.delete_column('oracle_cardface', 'colors')
    ...
    models = {
        ...
        'oracle.cardface': {
            ...
            'colors': ('arrayfields.fields.IntegerArrayField', [], {'null': 'True', 'blank': 'True'}),
