...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('oracle_cardl10n', 'file', self.gf('contrib.cdn.CDNFileField')(blank=True, max_length=100, null=True, storage_path='/mtgforge/media/'), keep_default=False)
