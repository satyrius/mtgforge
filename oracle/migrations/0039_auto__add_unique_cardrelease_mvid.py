...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CardRelease', fields ['mvid']
        db.create_unique('oracle_cardrelease', ['mvid'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CardRelease', fields ['mvid']
        db.delete_unique('oracle_cardrelease', ['mvid'])
