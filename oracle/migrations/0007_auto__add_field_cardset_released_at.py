...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CardSet.released_at'
        db.add_column('oracle_cardset', 'released_at', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CardSet.released_at'
        db.delete_column('oracle_cardset', 'released_at')
