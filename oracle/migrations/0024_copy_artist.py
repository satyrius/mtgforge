...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute("""
            update oracle_cardimage as ci
            set artist_id = cl.artist_id
            from oracle_cardl10n as cl
            where ci.id = cl.art_id
        """)

    def backwards(self, orm):
        db.execute("""
            update oracle_cardl10n as cl
            set artist_id = ci.artist_id
            from oracle_cardimage as ci
            where ci.id = cl.art_id
        """)
