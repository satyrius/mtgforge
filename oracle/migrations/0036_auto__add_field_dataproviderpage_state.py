...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataProviderPage.state'
        db.add_column('oracle_dataproviderpage', 'state', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataProviderPage.state'
        db.delete_column('oracle_dataproviderpage', 'state')
    ...
    models = {
        ...
        'oracle.cardface': {
            ...
            'fixed_power': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True'}),
            'fixed_thoughtness': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True'}),
            ...
            'power': ('contrib.fields.NullCharField', [], {'max_length': '10', 'null': 'True'}),
