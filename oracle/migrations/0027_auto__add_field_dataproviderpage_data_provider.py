...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Clear table, cause this data is not significant
        db.execute('truncate table oracle_dataproviderpage')

        # Adding field 'DataProviderPage.data_provider'
        db.add_column('oracle_dataproviderpage', 'data_provider', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['oracle.DataProvider']), keep_default=False)
    ...
    models = {
        ...
        'oracle.dataproviderpage': {
            'Meta': {'object_name': 'DataProviderPage'},
