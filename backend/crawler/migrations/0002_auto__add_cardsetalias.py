...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CardSetAlias'
        db.create_table(u'crawler_cardsetalias', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('card_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oracle.CardSet'], null=True, blank=True)),
        ))
        db.send_create_signal(u'crawler', ['CardSetAlias'])


    def backwards(self, orm):
        # Deleting model 'CardSetAlias'
        db.delete_table(u'crawler_cardsetalias')
