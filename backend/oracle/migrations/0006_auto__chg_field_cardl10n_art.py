...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CardL10n.art'
        db.alter_column(u'oracle_cardl10n', 'art_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['oracle.CardImage']))

    def backwards(self, orm):

        # Changing field 'CardL10n.art'
        db.alter_column(u'oracle_cardl10n', 'art_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oracle.CardImage'], null=True))
