...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CardL10n.mvid'
        db.add_column(u'oracle_cardl10n', 'mvid',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None),
                      keep_default=False)

        # Adding unique constraint on 'CardL10n', fields ['card_face', 'mvid']
        db.create_unique(u'oracle_cardl10n', ['card_face_id', 'mvid'])


    def backwards(self, orm):
        # Removing unique constraint on 'CardL10n', fields ['card_face', 'mvid']
        db.delete_unique(u'oracle_cardl10n', ['card_face_id', 'mvid'])

        # Deleting field 'CardL10n.mvid'
        db.delete_column(u'oracle_cardl10n', 'mvid')
