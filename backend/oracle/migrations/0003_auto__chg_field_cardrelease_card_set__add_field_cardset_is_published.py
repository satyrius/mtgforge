...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CardRelease.card_set'
        db.alter_column(u'oracle_cardrelease', 'card_set_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oracle.CardSet'], on_delete=models.PROTECT))
        # Adding field 'CardSet.is_published'
        db.add_column(u'oracle_cardset', 'is_published',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CardRelease.card_set'
        db.alter_column(u'oracle_cardrelease', 'card_set_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oracle.CardSet']))
        # Deleting field 'CardSet.is_published'
        db.delete_column(u'oracle_cardset', 'is_published')
