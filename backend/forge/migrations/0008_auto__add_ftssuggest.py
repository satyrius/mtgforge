...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FtsSuggest'
        db.create_table('forge_ftssuggest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('term', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
            ('weight', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('forge', ['FtsSuggest'])
        db.create_index('forge_ftssuggest', ['term', 'weight'])

    def backwards(self, orm):
        # Deleting model 'FtsSuggest'
        db.delete_table('forge_ftssuggest')
